  ...
  return (
    <div className="lg:w-[90%] w-full max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start mb-12">
        <div className="w-full lg:w-1/3 aspect-square flex items-center justify-center rounded-2xl bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-sm p-12">
          <div className="w-full h-full text-neutral-800 dark:text-neutral-100">
            {icon.icon}
          </div>
        </div>
        ...
        <div className="flex-1 w-full space-y-6">
          <div>
            ...
            <p className="text-lg text-neutral-500 dark:text-neutral-400 capitalize">
              {icon.name.replace('icon', '')} component
            </p>
          </div>
